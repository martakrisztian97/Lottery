...
public class Hatoslotto extends javax.swing.JFrame {
  ...
  private void initComponents() {
    ...
    balls.setIcon(new javax.swing.ImageIcon(getClass().getResource("/pictures/balls6.png"))); // NOI18N
  ...
  public static void main(String args[]) {
    ...
    try {
      ...
      java.util.logging.Logger.getLogger(Hatoslotto.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
