...
public class Skandinavlotto extends javax.swing.JFrame {
  ...
  private void initComponents() {
    ...
    setTitle("Skandináv lottó sorsolás");
    ...
    drawpicture.setBounds(10, 11, 684, 300);
    ...
    ball7.setBounds(622, 317, 72, 70);

    balls.setIcon(new javax.swing.ImageIcon(getClass().getResource("/pictures/balls7.png"))); // NOI18N
    getContentPane().add(balls);
    balls.setBounds(10, 317, 684, 72);
  ...
  public static void main(String args[]) {
    ...
    try {
      ...
      java.util.logging.Logger.getLogger(Skandinavlotto.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
